...
// component aliases
using friendly = fp::component< 'team', bool >;
using health   = fp::component< 'heal', int >;
using mana     = fp::component< 'mana', int >;
using coins    = fp::component< 'coin', int >;
using name     = fp::component< 'name', std::string >;
using position = fp::component< 'pos2', vec2f >;
...
int main()
{
    ...
    // systems; simulate a poison (-50%HP) to all entities that are not friendly (enemies)
